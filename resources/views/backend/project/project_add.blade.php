            ...
            <form action="{{route('project.store')}}" method="post">
                ...
                <div class="row">
                    <div class="col-sm-6 ">
                        ...
                        <input type="text" name="project_name" value="{{old('project_name')}}" id="input-name" class="form-control" required>
                        @error('project_name')
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="address" value="{{old('address')}}" id="input-address" class="form-control" required>
                        @error('address')
                ...
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <input type="date" name="start_date" value="{{old('start_date')}}" id="start_date" class="form-control" >
                        @error('start_date')
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" name="land_amount" value="{{old('land_amount')}}" id="input-land_amount" class="form-control">
                        @error('land_amount')
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="land_owner" value="{{old('land_owner')}}" id="input-land_owner" class="form-control">
                    </div>

                    <div class="col-sm-2">
                        <label class="control-label" for="input-owner_bill">মালিকের বিল</label>
                        <input type="text" name="owner_bill" value="{{old('owner_bill')}}" id="input-owner_bill" class="form-control">
                    </div>

                    <div class="col-sm-2 ">
                        <label class="control-label" for="input-installment">মালিকের কিস্তি</label>
                        <input type="number" name="installment" value="{{old('installment')}}" id="input-installment" class="form-control">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4 ">
                        ...
                        <input type="text" name="lease_holder" value="{{old('lease_holder')}}" id="input-lease_holder" class="form-control">
                    </div>

                    <div class="col-sm-2 ">
                        <label class="control-label" for="input-lease_bill">লিজদাতার বিল</label>
                        <input type="text" name="lease_bill" value="{{old('lease_bill')}}" id="input-lease_bill" class="form-control">
                    </div>

                    <div class="col-sm-2 ">
                        <label class="control-label" for="input-lease_installment">লিজদাতার কিস্তি</label>
                        <input type="number" name="lease_installment" value="{{old('lease_installment')}}" id="input-lease_installment" class="form-control">
                    </div>

                    <div class="col-sm-2 ">

                        <label class="control-label" for="input-land_owner">মোট চুক্তি বিল</label>
                        <input type="number" name="contract_bill" value="{{old('contract_bill')}}" id="input-contract_bill" class="form-control">
                        @error('contract_bill')
                    ...
                    <div class="col-sm-2 ">
                        ...
                        <input type="number" name="duration" value="{{old('duration')}}" id="input-contract_year" class="form-control">
                        @error('duration')
                ...
                <div class="col-sm-12 ">
                    ...
                    <input type="text" id="comments" name="comments" value="{{old('comments')}}" class="form-control">
                </div>

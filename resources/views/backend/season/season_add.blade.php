            ...
            <form action="{{route('season.store')}}" method="post">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="season_name" value="{{old('season_name')}}" id="input-name" class="form-control" required>
                        @error('season_name')
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="date" name="start_date" id="input-start_date" class="form-control" required>
                        @error('start_date')
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="date" name="end_date" id="input-end_date" class="form-control" required>
                        @error('end_date')

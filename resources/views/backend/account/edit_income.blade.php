                    ...
                    <form action="{{route('income.update',$income->id)}}" method="POST">
                        ...
                        <div class="mt-2">
                            ...
                            <select name="project" class="form-control" id="project">
                                ...
                                <option {{$income->project_id == $project->id?'selected':''}} value="{{$project->id}}">{{$project->project_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" name="amount" id="amount" class="form-control" placeholder="১২০০০" value="{{$income->amount}}">
                            @error('amount')
                        ...
                        <div class="mt-2">
                            ...
                            <textarea name="comment" id="comment" cols="30" rows="5" class="form-control" placeholder="মন্তব্য লিখুন">{{$income->comment}}</textarea>
                        </div>
